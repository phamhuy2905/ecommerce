import { ItemProduct } from "../../../../types/checkout.type";
import { formatCoin } from "../../../../utils/format";

function ItemCheckOut({ data }: { data: ItemProduct }) {
    return (
        <>
            <div className="my-2 flex items-center">
                <div className="mx-3">
                    <img className="h-[80px] w-[80px] object-cover" src={data.thumbnail} alt="Product" />
                </div>
                <p className="ml-3 w-[160px] truncate text-[15px]  text-gray-500">{data.name}</p>
